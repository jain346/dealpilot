  ...
  return (
    <main className="auth-screen">
      ...
      <section className="auth-form">
        ...
        <div id="google-signin-btn-container" style={{ minHeight: 44, width: "100%" }}>
          <button
            type="button"
        ...
        <form onSubmit={submit}>
          ...
          {mode === "signup" && form.password.length > 0 && form.password.length < 8 && (
            <p style={{ margin: 0, color: "var(--amber)", fontSize: "11px" }}>
...
function SettingsPage({ user }: { user: User }) {
  return (
    <PageFrame
      ...
      title="Settings"
      subtitle="Account and preference controls will live here as the workspace expands."
    >
      <section className="panel settings-card">
        <span className="kicker dark">Account</span>
      ...
      <main className="product-main">
        <header className="topbar">
          ...
          <div className="topbar-actions">
            <ThemeToggle />
            <DisabledButton className="icon-button">⌕</DisabledButton>
            <DisabledButton className="icon-button">♧</DisabledButton>
